...
static const char *mute_volume[] = { "amixer", "-q", "set", "Master", "toggle", NULL};
static const char *raise_volume[] = { "amixer", "-q", "set", "Master", "5+", "unmute",  NULL};
static const char *lower_volume[] = { "amixer", "-q", "set", "Master", "5-", "unmute",  NULL};
